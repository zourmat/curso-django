# Generated by Django 4.0.4 on 2022-05-26 01:13
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_staff', models.BooleanField(default=False, help_text='Designates whether the user can log into '
                                                                          'this admin site.', verbose_name='staff sta'
                                                                                                           'tus')),
                ('is_active', models.BooleanField(default=True, help_text='Designates whether this user should be trea'
                                                                          'ted as active. Unselect this instead of dele'
                                                                          'ting accounts.', verbose_name='active')),
